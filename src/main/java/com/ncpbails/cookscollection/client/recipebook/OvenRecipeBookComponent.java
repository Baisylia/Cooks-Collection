...
@Mod.EventBusSubscriber(modid = "cookscollection", bus = Mod.EventBusSubscriber.Bus.FORGE)
public class OvenRecipeBookComponent extends net.minecraft.client.gui.screens.recipebook.RecipeBookComponent {
    ...
    public void setupGhostRecipe(Recipe<?> recipe, List<Slot> slots) {
        if (!(recipe instanceof OvenRecipe) && !(recipe instanceof OvenShapedRecipe)) {
            return;
        }
                ...
                if (recipe instanceof OvenRecipe || recipe instanceof OvenShapedRecipe) {
                    ...
                    if (minecraft.player != null && minecraft.gameMode != null && minecraft.getConnection() != null) {
                        ...
                        if (canPlace) {
                            ...
                            minecraft.getConnection().send(new ServerboundPlaceRecipePacket(ovenMenu.containerId, recipe, false));
                        }
    ...
    public static void onPlayerJoin(ClientPlayerNetworkEvent event) {
        ...
        if (minecraft.player != null && minecraft.getConnection() != null) {
            minecraft.player.getRecipeBook().setOpen(ModRecipeBookTypes.OVEN, true);
            minecraft.player.getRecipeBook().setBookSetting(ModRecipeBookTypes.OVEN, true, true);
        }
    }
}