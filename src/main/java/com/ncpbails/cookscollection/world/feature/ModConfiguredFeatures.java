...
public class ModConfiguredFeatures {
    public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES =
            DeferredRegister.create(Registries.CONFIGURED_FEATURE, CooksCollection.MOD_ID);
            ...
            CONFIGURED_FEATURES.register("lemon", () ->
                    new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                            ...
                            new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder()
                                    .add(ModBlocks.LEMON_LEAVES.get().defaultBlockState(), 8)
                                    .add(ModBlocks.FRUITING_LEMON_LEAVES.get().defaultBlockState().setValue(FruitingLeaves.AGE, 4), 1)),
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> LEMON_SPAWN =
            CONFIGURED_FEATURES.register("lemon_spawn", () -> new ConfiguredFeature<>(Feature.RANDOM_SELECTOR,
                    new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(
                            ModPlacedFeatures.LEMON_CHECKED.getHolder().orElseThrow(), 0.5F)),
                            ModPlacedFeatures.LEMON_CHECKED.getHolder().orElseThrow())));

    public static final Supplier<List<OreConfiguration.TargetBlockState>> OVERWORLD_SALT = Suppliers.memoize(() -> List.of(
            OreConfiguration.target(new BlockMatchTest(Blocks.STONE), ModBlocks.SALTED_DRIPSTONE_BLOCK.get().defaultBlockState()),
            OreConfiguration.target(new BlockMatchTest(Blocks.DEEPSLATE), ModBlocks.SALTED_DRIPSTONE_BLOCK.get().defaultBlockState())));
